...
public enum SessionDot {
    ...
    static let form: [String: (d: CGFloat, holeInset: CGFloat, corner: CGFloat)] = [
        "blocked": (9, 0.5,  0),     // filled SQUARE — the one that stops you
        "waiting": (9, 0.5, 99),     // filled circle — finished, wants a prompt
        "working": (9, 0.34, 99),    // ring — running, nothing for you to do
        "idle":    (5, 0.5, 99),     // a small filled dot — a shell, nothing to say
        ...
        "unknown": (7, 0.25, 99),    // a ring — Chute does not know, and says so
