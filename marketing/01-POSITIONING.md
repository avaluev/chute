...
## One paragraph
Chute is a macOS utility for people who spend their day driving coding agents. Select files in
Finder and get clean paths, or every file's contents bundled into one paste-ready blob with a
token count. Paste an agent's multi-file answer and get real files back. Snapshot a repo before
you let an agent loose. It is offline, has no account, and costs one payment.
...
> For AI product builders who run coding agents all day, Chute is a macOS utility that turns your
> Finder selection into agent-ready context and turns agent output back into files. Unlike
...
| Claim | Evidence |
|---|---|
| Saves 90–120 min/day | `docs/03-JTBD-LEDGER.md` — 24 JTBDs with per-job arithmetic |
