...
5. It is a 2.4 MB macOS app with no account, no subscription and no network code. The `chute`
...
| Not bloatware | 2.4 MB, zero third-party dependencies, no launch daemon, no background service |
