...
5. It is a 3.0 MB macOS app with no account, no subscription and no network code. The `chute`
...
| Not bloatware | 3.0 MB, zero third-party dependencies, no launch daemon, no background service |
