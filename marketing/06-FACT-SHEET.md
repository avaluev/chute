...
| Lines of Swift | **12,542** | `find Sources -name '*.swift' \| xargs wc -l \| tail -1` |
...
| Gate | Result | Command |
|---|---|---|
| Unit assertions | **1,065 passed** | `swift run -c release chutetests` |
