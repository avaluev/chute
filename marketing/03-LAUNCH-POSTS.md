...
**Description:**
> Your agent can read your whole repo. You spend the day telling it which part. Chute is a 2.8 MB
...
> does. 2.8 MB, zero dependencies, no launch daemon, no telemetry, no account, no subscription.
